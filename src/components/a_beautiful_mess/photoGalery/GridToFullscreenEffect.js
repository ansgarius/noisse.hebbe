...
loader.load(
  ...
  (response) => {
    ...
    image.onload = function () {
      console.log(img,'================================');
      img[0].large.element=image
      img[0].large.image=image
      img[0].small.element=image
      img[0].small.image=image
      console.log(img,'================================');
  ...
  createTextures(images) {
    ...
    /*   let largeTexture = new THREE.TextureLoader();
      largeTexture.setRequestHeader({"Access-Control-Allow-Origin":"*"})
      largeTexture.crossOrigin = 'anonymous'
     largeTexture=largeTexture.load(imageSet.large.image ) */
...
/*       let smallTexture = new THREE.TextureLoader();
      smallTexture.setRequestHeader({"Access-Control-Allow-Origin":"*"})
    smallTexture.crossOrigin = 'anonymous'

    smallTexture= smallTexture.load(imageSet.small.image ) */
